...
import com.smhrd.dtect.dto.member.SignupRequestDTO;
...
import com.smhrd.dtect.entity.field.Field;
...
import com.smhrd.dtect.repository.field.FieldRepository;
...
public class UserService {
    ...
    public Long findUserIdByMemIdx(Long memIdx) {
        return userRepository.findByMember_MemIdx(memIdx)
                .map(u -> u.getUserIdx())
                .orElseThrow(() -> new IllegalStateException("일반 사용자 레코드를 찾을 수 없습니다."));
    }
}
